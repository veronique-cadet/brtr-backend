...
lilia = User.create(first_name: "Lila", last_name: "Gupta", email: "lila.gupta@gmail.com", password: "password17", age: 26, bio: "Hey there, I'm Lila! I'm a graphic designer and I love creating beautiful and functional designs. I'm also a big fan of nature and I like to go on hikes and picnics. In my free time, I like to draw, paint, and read. Allow me to bring my skills and unwavering work ethic to the table to help you achieve your goals.", picture: "https://randomuser.me/api/portraits/women/91.jpg", city: "Bronx", state: "NY", rating: 4.5 )
...
UserSkill.create(user_id: lila.id, skill_id: user_experience_design.id, years_exp: 5 avg_hr: 100, proof_des: "hi", proof_url: "hi")
UserSkill.create(user_id: lila.id, skill_id: cooking.id, years_exp:  avg_hr: 100, proof_des: "hi", proof_url: "hi")
