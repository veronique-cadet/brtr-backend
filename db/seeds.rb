...
Barter.create(proposer_id: vero.id, recipient_id: cindy.id, proposer_skill_id: one.id, recipient_skill_id: three.id)
Barter.create(proposer_id: trevor.id, recipient_id: vero.id, proposer_skill_id: two.id, recipient_skill_id: six.id)
Barter.create(proposer_id: cindy.id, recipient_id: vero.id, proposer_skill_id: seven.id, recipient_skill_id: four.id)
