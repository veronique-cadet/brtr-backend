...
Barter.create(proposer_id: trevor.id, recipient_id: vero.id, proposer_skill_id: two.id, recipient_skill_id: six.id, proposer_hours: 7, recipient_hours: 5, agreed: true)
