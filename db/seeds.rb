...
twentyone = UserSkill.create(user_id: emily.id, skill_id: yoga.id, years_exp: 4, avg_hr: 100, proof_des: "hi", proof_url: "hi")
...
twentyeight =  UserSkill.create(user_id: jonathan.id, skill_id: yoga .id, years_exp: 3, avg_hr: 100, proof_des: "hi", proof_url: "hi")
...
thirthy=  UserSkill.create(user_id: mia.id, skill_id: photography.id, years_exp: 4, avg_hr: 100, proof_des: "hi", proof_url: "hi")
...
melanieSkill = UserSkill.create(user_id: melanie.id, skill_id: programming.id, years_exp: 5, avg_hr: 100, proof_des: "hi", proof_url: "hi")
